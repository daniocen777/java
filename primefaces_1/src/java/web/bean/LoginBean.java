    ...
    public void login(ActionEvent event) {
        ...
        if (list.isEmpty()) {
            if (usuarios.getUsuario().equals(usuarios.getPassword())) {
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("usuario", usuarios.getNombres() + " " + usuarios.getApellidos());

                loggedIn = true;
                ruta = "/primefaces_1/faces/admin/index.xhtml";
            }
